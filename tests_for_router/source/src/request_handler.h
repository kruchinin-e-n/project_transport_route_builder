...
namespace transport_catalogue {
    ...
    namespace infrastructure {
            ...
            class RequestHandler {
                ...
                const std::optional<ext_libs::graph::Router<double>::RouteInfo> BuildRoute (std::string_view stop_from, std::string_view stop_to) const;
                const ext_libs::graph::DirectedWeightedGraph<double>& GetTransportRouterGraph() const;
